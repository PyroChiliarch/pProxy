...
func HttpClientGetJarHandler(w http.ResponseWriter, r *http.Request) {
...
func HttpClientDoRequestStartHandler(w http.ResponseWriter, r *http.Request) {
...
func HttpClientDoRequestMsgHandler(w http.ResponseWriter, r *http.Request) {
...
func HttpClientDoRequestEndHandler(w http.ResponseWriter, r *http.Request) {
